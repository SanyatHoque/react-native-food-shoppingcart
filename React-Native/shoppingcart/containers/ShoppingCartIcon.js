...
const ShoppingCartIcon = (props) => (
    <View style={[{ padding: 5 }, Platform.OS == 'android' ? styles.iconContainer : null]}>
        <View style={{
            position: 'absolute', height: 30, width: 30, borderRadius: 15, backgroundColor: 'rgba(255, 0, 0, 0.4)', right: 15, bottom: 15, alignItems: 'center', justifyContent: 'center', zIndex: 2000,
